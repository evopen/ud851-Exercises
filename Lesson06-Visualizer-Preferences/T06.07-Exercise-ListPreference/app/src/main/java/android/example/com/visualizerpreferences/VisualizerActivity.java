...
public class VisualizerActivity extends AppCompatActivity implements SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    private void setupSharedPreferences() {
        ...
        loadColorPreferences(sharedPreferences);
        // Register the listener
        sharedPreferences.registerOnSharedPreferenceChangeListener(this);
    }

    private void loadColorPreferences(SharedPreferences preferences) {
        mVisualizerView.setColor(
                preferences.getString(
                        getString(R.string.pref_set_color_key),
    ...
    public void onSharedPreferenceChanged(SharedPreferences sharedPreferences, String key) {
        ...
        } else if (key.equals(getString(R.string.pref_set_color_key))) {
            loadColorPreferences(sharedPreferences);
        }
    }
