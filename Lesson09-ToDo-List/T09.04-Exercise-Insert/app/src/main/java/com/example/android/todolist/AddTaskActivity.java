...
public class AddTaskActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mItemTitleEditText = (EditText) findViewById(R.id.editTextTaskDescription);
    }
    ...
    public void onClickAddTask(View view) {
        ...
        String input = mItemTitleEditText.getText().toString();
        ...
        Uri itemUri = contentResolver.insert(TaskContract.TaskEntry.CONTENT_URI, cv);
        Toast.makeText(this, itemUri.toString(), Toast.LENGTH_SHORT).show();
