...
public class NotificationUtils {
    ...
    private static final int IGNORE_REMINDER_PENDING_INTENT_ID = 2452;
    private static final int DRINK_WATER_PENDING_INTENT_ID = 2352;
    ...
    public static void remindUserBecauseCharging(Context context) {
        ...
        NotificationCompat.Builder notificationBuilder = new NotificationCompat.Builder(context, WATER_REMINDER_NOTIFICATION_CHANNEL_ID)
                ...
                .addAction(ignoreRemiderAction(context))
    ...
    private static NotificationCompat.Action ignoreRemiderAction(Context context) {
        ...
        PendingIntent pendingIntent =
                PendingIntent.getService(context,
                        IGNORE_REMINDER_PENDING_INTENT_ID,
                        intent,
    ...
    private static NotificationCompat.Action drinkWaterAction(Context context) {
        ...
        PendingIntent pendingIntent = PendingIntent.getService(context,
                ...
                PendingIntent.FLAG_UPDATE_CURRENT);
        NotificationCompat.Action action =
                new NotificationCompat.Action(R.drawable.ic_local_drink_black_24px,
                        "Drink it!",
                        pendingIntent);
        return action;
    }
