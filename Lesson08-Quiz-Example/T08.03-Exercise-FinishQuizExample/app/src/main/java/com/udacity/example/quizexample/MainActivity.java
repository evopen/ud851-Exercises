...
public class MainActivity extends AppCompatActivity {
    ...
    public void nextWord() {
        ...
        int columnIndex = mData.getColumnIndex(DroidTermsExampleContract.COLUMN_WORD);
        if (mData.moveToNext() || mData.moveToFirst()) {
            String word = mData.getString(columnIndex);
    ...
    public void showDefinition() {
        ...
        int columnIndex = mData.getColumnIndex(DroidTermsExampleContract.COLUMN_DEFINITION);
        String definition = mData.getString(columnIndex);
