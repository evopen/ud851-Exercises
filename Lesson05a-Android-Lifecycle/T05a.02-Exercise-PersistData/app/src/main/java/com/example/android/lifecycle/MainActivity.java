...
public class MainActivity extends AppCompatActivity {
    ...
    private static final String KEY_CALLBACKS_TEXT = "CALLBACKS_TEXT";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null && savedInstanceState.containsKey(KEY_CALLBACKS_TEXT)) {
            mLifecycleDisplay.setText(savedInstanceState.getString(KEY_CALLBACKS_TEXT));
        }
    ...
    protected void onSaveInstanceState(Bundle outState) {
        ...
        outState.putString(KEY_CALLBACKS_TEXT, mLifecycleDisplay.getText().toString());
    }
